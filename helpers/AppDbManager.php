 ...
 * @since 2.0
 */
class AppDbManager extends BaseManager
{
    /**
    ...
    protected function checkAccessRecursive($user, $itemName, $params, $assignments)
    {
        ...
        $cacheKey='checkAccessRecursive-'.$itemName;
        ...
        if (!isset($this->requestCache[$cacheKey]))
        {
          ...
          $this->requestCache[$cacheKey]=$parents;
        }

        $parents=$this->requestCache[$cacheKey];
    ...
    protected function getItem($name)
    {
        ...
        $cacheKey='getItem-'.$name;

        if (!isset($this->requestCache[$name]))
        {
          $row = (new Query)->from($this->itemTable)
          ->where(['name' => $name])
          ->one($this->db);

          $this->requestCache[$name]=$row;
        }

        $row=$this->requestCache[$name];
    ...
    public function getAssignments($userId)
    {
        ...
        $cacheKey='assignments-'.(string)$userId;
        ...
        if (!isset($this->requestCache[$cacheKey]))
        {
          ...
          $this->requestCache[$cacheKey]=$assignments;
        }
    ...
    public function loadFromCache()
    {
        ...
        $this->cache->set($this->cacheKey, [$this->items, $this->rules, $this->parents], 60);
    }
